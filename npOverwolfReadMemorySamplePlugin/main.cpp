...
/*
  ...
  2. Best to rename the output file from npOverwolfReadMemorySamplePlugin to your
      own name

  3. Edit npOverwolfReadMemorySamplePlugin.rc version resource to your own properties
  ...
  4. Browser ---> nsPluginInstance::NPPVpluginScriptableNPObject(
                             ...
                             - we return new nsScriptableObjectOverwolfReadMemorySample()

  5. Script ---> plugin().exampleAsyncFunction("hi", function(echo) {}) --->
                       nsScriptableObjectOverwolfReadMemorySample::Invoke() --->
                       nsScriptableObjectOverwolfReadMemorySample::ExampleAsyncFunction
...
char kMimeType[] = "application/x-overwolf-memory-read-sample-plugin";
...
nsPluginInstanceBase* NS_NewPluginInstance(
  ...
  nsPluginInstanceOverwolfReadMemorySample* plugin = 
    new nsPluginInstanceOverwolfReadMemorySample(aCreateDataStruct->instance);
...
void NS_DestroyPluginInstance(nsPluginInstanceBase * aPlugin) {
  if(aPlugin) {
    delete (nsPluginInstanceOverwolfReadMemorySample*)aPlugin;
  }
}
